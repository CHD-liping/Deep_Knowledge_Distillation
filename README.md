# Deep Knowledge Distillation: Self mutual knowledge distillation for traffic prediction
...
Our research inherits the data from DCRNN, if it is helpful to you, please cite the following paper:
```
