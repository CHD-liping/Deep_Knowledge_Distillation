...
class DCRNNModel(nn.Module, Seq2SeqAttrs):
    ...
    def encoder(self, inputs):
        ...
        return encoder_hidden_state,encoder_outputs
    ...
    def decoder(self, encoder_hidden_state, labels=None, batches_seen=None):
        ...
        for t in range(self.decoder_model.horizon):
            ...
            #decoder_hidden_state_temp.append(decoder_hidden_state)
            if self.training and self.use_curriculum_learning:
                c = np.random.uniform(0, 1)
                if c < self._compute_sampling_threshold(batches_seen):
                    decoder_input = labels[t]
        outputs = torch.stack(outputs)
        #decoder_hidden_state_temp = torch.stack(decoder_hidden_state_temp)
        return outputs
    ...
    def forward(self, inputs, labels=None, batches_seen=None):
        ...
        encoder_hidden_state,encoder_outputs=self.encoder(inputs)
